...
$Maps = "/Game/Genesis/Conception/Maps/L_GEN_OviductAmpulla+/Game/Genesis/Implantation/Maps/L_GEN_UterineCavity+/Game/Genesis/Embryogenesis/Maps/L_GEN_Fruchthoehle+/Game/Genesis/Birth/Maps/L_GEN_Birth"
