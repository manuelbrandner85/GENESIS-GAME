...
| GENESIS-044 | Die Fetalzeit | Woche 9–40 nach Referenzkurven (Scheitel-Steiß-Länge, Gewicht): erste Bewegungen, Schlucken, Daumenlutschen, Kindsbewegungen spürbar (Woche 18–20), Hören (24–26), Augen öffnen (26–28), Lungenreife, Drehung in Schädellage (32–36). Der Spieler bewegt sich, hört, reagiert | IN ARBEIT (Teil 1a: Simulation BETA; Teil 1b: Mutterleib aus Sicht des Kindes ALPHA, Doc 34; Teil 2a: Handlungen und Sinne ALPHA; Teil 2b: das Kind je Woche von außen ALPHA, Doc 37; Teil 2c: frühe Wochen SSW 8–16 von außen ALPHA; Befruchtung geprüft, Doc 38) |
...
| GENESIS-047 | Die Befruchtung, wie sie wirklich abläuft | Korrektur nach Doc 38. Teil 1: 150 statt 6.000 Spermien, die nach und nach eintreffen; Kapazitation als eigener Zustand (~10 %), nur diese Zellen folgen dem Lockstoff; Akrosomreaktion schon im Cumulus möglich; schräg durch die 17 µm dicke Zona in ~13 min, dann der perivitelline Spalt (16 ± 6 min) bis zur Verschmelzung; Schutz über Minuten, Überzählige bleiben im Spalt liegen; sichtbarer Zeitraffer ×45 mit Uhr; zweiter Polkörper nach 3,5 h. Teil 2a: Cumulus in echter Größe (~16.000 Zellen, 1,4 mm mit Gallerte) als Hindernis für die Spermien, Eileiter doppelt so weit, 80 Zellen im Abschnitt, Zeit im Spalt nach der Siegerin kalibriert. Teil 2b: freier Blick auf Zona und Spalt im Zeitraffer – optischer Schnitt, Profilansicht, Relief-Kontrast wie Hoffman/DIC. Teil 2c: transzonale Fortsätze entfernt (beim Eisprung zurückgezogen), Kopf im Spalt auf der Membran. Teil 2d: Schwimmen statt Zucken – Geißel-Shader las die gespiegelte UV (der Kopf schlug als freies Ende), Glättung zwischen den Rechenschritten, ruhige Kamera | IN ARBEIT (Teil 1–2d ALPHA) |
...
- 2026-09-21: Game Director: „Fahre fort und realistischer."
- 2026-09-21: Das Kind schreit mit echten Aufnahmen (kie.ai Suno sounds, 15 Credits). Automatisch geprüft: Grundton 410–471 Hz, wie bei Neugeborenen. Erster Schrei nach der Geburt, dann kräftig oder wimmernd nach dem Zustand, ruhige Laute auf der Haut, still im Schlaf (neuer Test ChildSounds). Die Synthese ist abgeschaltet.
- 2026-09-21: Raumklang des Kreißsaals nachts, vor der Geburt gedämpft. Messfehler gefunden: Unreal stellt Fenster im Hintergrund stumm; die Testläufe setzen das jetzt auf 1.
- 2026-09-21: Cumuluszellen mit angedeutetem Kern, Granula und hellem Saum statt glatter Plastikeier. Das rote Durchscheinen von Eizelle, Polkörper und Cumulus war erfunden und ist entfernt. Drei Anläufe, alle am Bild geprüft.
...
- 2026-09-21: Game Director: „Stimme synchron mit der Lippenbewegung, alles hyperfotorealistisch; die Hebamme in echter Kreißsaal-Kleidung mit Handschuhen, und so soll sie sich verhalten."
- 2026-09-22: Hebamme als MetaHuman (AGenesisMidwifeRig). Sie fängt das Kind auf, hebt es vor ihr Gesicht und legt es der Mutter auf die Brust. Die Kamera des Kindes liegt in ihren Händen.
- 2026-09-22: Lippensynchronität: Das StreamingADA-Modell (UE 5.8) erzeugt im Editor aus allen 32 Aufnahmen Spuren der RigLogic-Rohsteuerungen. Im Spiel laufen sie auf der Audio-Uhr mit der Stimme. Gemessen öffnet sich der Kiefer im Median 20 ms vor dem Laut. Test LipSync.Playback.
- 2026-09-22: Kleidung: Kasackhose und Nitrilhandschuhe als Hüllen auf dem Körper-Mesh (Material nach Referenzpose). Das Geburtstuch hing als „hautfarbener Schlauch" über ihrem Kopf; es hängt jetzt über den Knien der Frau und ist ungefärbte Baumwolle.
- 2026-09-22: 132 von 132 Tests.
- Offen: Abtrocknen und Zudecken des Kindes, Kasack mit V-Ausschnitt.

### GENESIS-039 (Teil 5) – Die Hebamme: echte Kleidung, lebendige Arme, Versorgung des Kindes
- 2026-09-22: Game Director: „Die Beine der Hebamme sehen sehr künstlich aus und die Arme zu steif – das Maximum an Fotorealismus; Physik und das Organische müssen 100 % passen."
- 2026-09-22: Kasackhose und Clogs als echte Kleidungsstücke: Schnitt aus ihrem Körper gemessen, Stoffsimulation in Blender, an den Beinen die Hautgewichte des Körpers, 5 mm Mindestabstand zur Haut (306 Punkte lagen darin). Die MetaHuman-Figur war barfuß.
- 2026-09-22: Arme: Hände lagen 57 cm vor der Schulter (länger als ihr Arm) – Halteort jetzt von den Schultern aus, Ellenbogen gebeugt, Finger gebeugt, Gewichtsverlagerung und Mikrobewegungen.
- 2026-09-22: Versorgung: nach einer halben Minute auf die Brust (Leitlinie), abrubbeln (Geräusch, Satz, Bewegung), zudecken (Rand des Tuchs im Bild). Wärme: nass/abgetrocknet/zugedeckt (Test DryingAndCoveringKeepWarm). Zwei neue Sätze der Hebamme (kie.ai, ~5 Credits).
- 2026-09-22: Alle Geräusche liefen nur zu ~45 % (MP3-Import): jetzt WAV. Lumen Hit Lighting (+0,7 ms). 134 von 134 Tests. Doc 29.

### GENESIS-039 (Teil 6) – Rendering: Maximum bei spielbarer Bildrate
- 2026-09-22: Game Director: „Rendere das Spiel mit Unreal Engine auf Photorealismus."
- 2026-09-22: Gemessen im fertigen Spiel (Full HD nativ): 25 ms → 15 ms (~67 fps), ohne sichtbaren Verlust. Haar-Voxel der MetaHumans im Maßstab der Szene (vorher 1000-fach zu fein, 6 ms), MegaLights für die Flächenleuchten im Kreißsaal (−4 ms). Unter dem Mikroskop MegaLights aus – die Spermien verschwanden sonst. Test HairVoxelsFollowScale, 135 von 135 Tests.

### GENESIS-039 (Teil 7) – Der Kasack
- 2026-09-22: Kasack statt T-Shirt: das T-Shirt des MetaHuman, bis über die Hüfte verlängert (Saum geöffnet, beide Stofflagen gerade weitergeführt, neu geschlossen), Brusttasche. Ein eigener Ringschnitt mit V-Ausschnitt riss beim Heben der Arme auf, ein angesetzter Schoß wirkte wie ein Gürtel – beide verworfen (Bilder in Doc 29). Handschuhe mit animierter Normale (keine Haut mehr an den Knöcheln). 135 von 135 Tests.

### GENESIS-039 (Teil 8) – Die Mutter nach der Geburt
- 2026-09-22: Durchsicht Bild für Bild im fertigen Spiel: Die Mutter sah trocken und frisch aus. Jetzt Schweißglanz und Röte aus der Anstrengung, in der ersten Stunde abklingend (Gesicht und Körper, Regler der MetaHuman-Haut). Tuch über dem Kind verdeckte ihr Gesicht – zurückgesetzt. Doc 25.

### GENESIS-040 (Teil 1) – Die zweite Woche als Simulation
- 2026-09-22: „Einnistung" war eine Zahl, die in 48 h von 0 auf 1 stieg. Jetzt sieben Stufen nach Lehrbuch: Anlagerung (Tag 6), Anheftung, Invasion mit Synzytium und zweiblättriger Keimscheibe (7–8), Lakunen, Amnion und primärer Dottersack (9), ganz eingebettet (10), mütterliches Blut in den Lakunen (11–12), Primärzotten und sekundärer Dottersack (13, eingenistet). Jeder Keim auf seiner eigenen Uhr, alle Größen aus der Uhr gerechnet (gleich bei jeder Schrittweite). hCG ab Tag 9,5 messbar, Verdopplung in 31 h (Barnhart: mindestens +53 % in 48 h). Frühes Ende nach dem Tag der Einnistung (Wilcox 1999: 13/26/52/82 %), gemessen 13,8 % bzw. 58,6 % bei 1000 Keimen, der Keim des Spielers nie. Anzeige zeigt Tag, Größe, hCG und einen Satz je Stufe. Doc 30. Tests SecondWeek, SecondWeekStepIndependent, ImplantationRisk; 20 von 20 in Embryo und Durchlauf.

### GENESIS-040 (Teil 2) – Die Gebärmutter: ein neuer Ort
- 2026-09-22: Nach dem Schlüpfen wechselt der Durchlauf in die Gebärmutter (neue Karte L_GEN_UterineCavity). Schleimhaut der Sekretionsphase aus anatomischen Maßen (Blender, 1,75 Mio. Punkte, Nanite): Polster, geschwungene Furchen, 1207 Drüsenöffnungen in dichteren und lichteren Feldern; Epithelzellen, Pinopoden und Kapillarnetz im Material. Der Keim ist hier eine durchscheinende Zellhülle mit sichtbarem Embryoblast, der sich beim Anlagern nach unten dreht; er sinkt ein, ein Fibrinpfropf schließt die Stelle, das Epithel wächst zu, die Stelle rötet sich und wölbt sich vor. Hysteroskop-Kamera mit geregeltem Kaltlicht. Gefunden und behoben: Vertexfarben kommen in Unreal gar nicht an (auch an der Eileiterwand – eigener Punkt), PNG-Infill bei Alpha 0, Rot/Blau-Tausch im Format Vector Displacement Map, NaN durch pow() mit negativer Basis, Kamera über der Gegenwand, 1,5 EV Überbelichtung. Doc 30. Tests ImplantationView und EmbryoMap; 140 von 140.

### GENESIS-045 – Die Bildsprache des Covers
- 2026-09-22: Game Director: „Dies wird das Cover, orientiere dich an das Cover." Farben am Coverbild gemessen (Tiefen #0B0A0C, kaltes Leuchten #798999, Gold #C6A28F, Spitzlichter #E9E2DD; 36 % der Fläche kalt, 27 % warm, mittlere Leuchtdichte 0,28) und als Regeln festgeschrieben (Doc 31). Titelkarte und Startbildschirm tragen sie: „GENESIS" in Gold und in Cinzel (SIL Open Font License) mit weitem Buchstabenabstand und weichem Schein, feine goldene Linie, Untertitel in Kapitälchen, darüber „Jede Entscheidung hinterlässt ein Echo"; der Schleier ist tiefes Blauschwarz mit Verlauf statt einer braunen Fläche, die Auswahl ein goldener Strich. Eigene Fehler: Schrift-Import bricht headless ab (jetzt im vollen Editor), ein Font-Asset lässt sich per Skript nicht bauen (das HUD baut die Laufzeitschrift selbst), Schleier als Fläche hinterließ eine Kante, als 32 Streifen feine Linien. Test Genesis.Frontend.TitleFont; 141 von 141.
...
### GENESIS-041 (Teil 1) – Der Bauplan als Simulation
- 2026-09-22: Die dritte und vierte Woche rechnet: Primitivstreifen (Tag 15), Gastrulation, Chorda, Neuralplatte, Somitenpaare im Takt von sieben Stunden, **der erste Herzschlag an Tag 22** (70–85/min, steigend), Neuralrohr schließt von der Mitte nach vorn (Tag 25) und hinten (Tag 27), Kiemenbögen, Augenbläschen, Extremitätenknospen. Gemessen Tag 28: 4,6 mm, 28 Somitenpaare, Herz 111/min. Neuralrohrdefekte hängen an der Ernährung der Mutter (0,40 % bei schlechter, 0,03 % bei guter; über 4000 Keime bestätigt) – der Keim des Spielers ist ausgenommen. Die Phase des Durchlaufs endet jetzt nicht mit der Einnistung, sondern wenn der Bauplan steht; im Zeitraffer 12 h/s: erster Herzschlag nach 18 s, fertig nach 30 s. Doc 32. 145 von 145 Tests.

### GENESIS-046 – Der Vorfilm
- 2026-09-22: Game Director: „Nutze diesen Trailer, aber so, dass er läuft, bevor das Spiel beginnt – weniger als Trailer, mehr wie der Film am Anfang eines Spiels.“ Der Trailer läuft jetzt als eigene Stufe des Startablaufs (Media Framework): Studio → Engine → Hinweis → **Vorfilm** → Startbildschirm. Er ersetzt den Prolog, weil beide dieselben Sätze sprechen; fehlt die Datei (sie liegt nicht im Repository, 300 MB), erzählt der Prolog wie bisher. Weg ist nur die Werbekarte „Bald erhältlich für PC“; der Film endet auf der Titelkarte, danach direkt „Drücke eine beliebige Taste“ (kein zweiter Titel). 22 Untertitel, an der Sprachspur gemessen, mit Sprechernamen, im unteren Kinobalken, an die Filmzeit gekoppelt. Menümusik und Szenenton treten unter dem Film ganz zurück. Zweimal drücken zum Überspringen, der Ton klingt aus. Geprüft im gebauten Spiel: Bildfolge, Protokoll, Überspringen, und der Tonpegel der Spielsitzung – in Filmsekunde 27–28 exakt 0,000, die Stille vor der Geburt aus dem Schnitt. Kodierung gemessen (HIGH 1,3–1,9 von 255 Stufen Abweichung, MEDIUM bis 3,2). Eigene Fehler: erst als Engine-Startfilm gebaut (lief vor dem Hinweis auf Lichtwechsel und doppelte Prolog und Titel), der Anfang war um 3 s gekürzt und schnitt den ersten Satz mitten im Wort ab (erst beim Vermessen der Stimme gefunden), Untertitel zu klein (24 px bei 1080p, jetzt 37 px). Tests Boot.Film und Boot.FilmSubtitles; 147 von 147. Doc 33, Nachtrag in Doc 23.

### GENESIS-041 (Teil 3) – Der Embryo nach Referenzen, live in Blender
- 2026-09-23: Game Director: „Baue das in Blender live, recherchiere vorher alle Bilder.“ 25 Referenzbilder von Wikimedia Commons (Lizenzen je Bild notiert, nur lokal): vor allem Blechschmidt-Rekonstruktionsmodelle echter Embryonen (2,5–6,3 mm) und ein Präparat mit 4–5 Wochen, dessen Landmarken im Raster abgelesen wurden (6,7 µm je Bildpunkt). Neuer Aufbau statt der Röhre des Prototyps: Rumpf in 14 gemessenen Querschnitten, Rückenwülste, Kopf aus drei Hirnbläschen, Kiemenbögen, Herz- und Leberwulst, Knospen; Somitenfurchen, Mittellinie, Ohr- und Linsengrübchen als Verschiebung (700 000 Punkte, 4,6 mm). Innen als eigene Körper: Herzschlauch mit Blut, Aortenbögen, Rückenaorten, Hirnwand um die Ventrikel, Neuralrohr mit Lumen, 30 Somitenpaare, Leberanlage – der Embryo ist mit vier Wochen fast durchsichtig. Gewebe nach der Physik im Fruchtwasser (Brechzahlsprung 1,03: kaum Glanz; streuendes Mesenchym, freie Weglänge 1,7 mm). Sieben eigene Fehler gefunden und behoben (Doc 32), u. a. Wurm statt gefülltem C, Wachsglanz gegen Luft, Somiten außerhalb des Körpers. Nebenbei behoben: `measure_exposure` maß 16-Bit-Bilder linear. Stand ALPHA: Blender fertig für Tag 28, Unreal, Dottersack und die Tage davor offen.
...
### GENESIS-044 (Teil 1b) – Der Mutterleib aus Sicht des Kindes
- 2026-09-23: Die Schwangerschaft ist kein schwarzer Zeitraffer mehr. Neue Karte `L_GEN_Mutterleib` (Blender `build_mutterleib.py`, Unreal `setup_mutterleib.py`), neuer Actor `AGenesisWombScene`: Die Kamera ist das Kind.
- Der Tag der Mutter als Simulation (`GenesisMotherDay`): Schlaf, Essen, Arbeit, Spaziergang, Gespräch mit dem Bauch, Musik; daraus Puls, Stimme, Verdauung, Wiegen und das Licht im Mutterleib (Durchlass nach Parraguez 1998 – am Schaf gemessen, offen so benannt).
- Sieben Momente von SSW 19 bis 37 (Das Hören beginnt, die ersten Tritte, Nacht, die Lider öffnen sich, Licht durch den Bauch, feineres Hören, Enge). Jeder Moment sucht sich in seiner Woche den Tag, an dem die Situation wirklich eintritt. Zusammen 6,1 min.
- Wahrnehmung statt Kamera: Licht nach Lidern und Pupille, Eigengrau im Dunkeln, Unschärfe, eigene Bewegungen als Ruck, ihr Gehen als Wiegen. Ton durch den Hörfilter des Kindes, ihre Stimme ab SSW 16.
- HUD: Kapitelzeile je Moment, darunter SSW, Länge, Gewicht, Herzfrequenz.
- Referenzen und Lizenzen: Doc 36 (Board „Der Mutterleib von innen“).
- Fehler unterwegs: Die Nabelschnur war schwarz (Lumen gibt kleinen Teilen keine Oberflächenkarten; Szene jetzt ×10). Kein Durchlicht von leuchtenden Wänden in Unreal, deshalb im Material nachgebildet. Momente im Zimmer fast schwarz (halbe Anpassung). Erster Ton praktisch unhörbar (0,07). Ein Gefäß stach durch die Nabelschnur.
- Geprüft im gebauten Spiel mit Autopilot: 368 s Schwangerschaft, alle Momente, Stimme, Geburt. GPU 3,9 ms. Tests Slice.WombPerception, People.MotherDay; 156 von 156.
- Stand ALPHA. Nächster Auftrag des Game Directors (während der Arbeit eingegangen): den Fetus selbst in allen Wochen zeigen (von außen, dann in die Ich-Perspektive), kleine eigene Bewegungen des Spielers, alle Sinne.

### GENESIS-044 (Teil 2a) – Handlungen des Kindes und alle Sinne
- 2026-09-23: Game Director: „Der Spieler soll auch kleine Mikro-Interaktionen machen können, z. B. Hand bewegen oder sich leicht bewegen, pupsen usw. … Der Spieler muss mit allem alles wahrnehmen können.“ Recherchiert (Doc 37): Pupsen gibt es im Mutterleib nicht (keine Luft im Darm), Wasserlassen dagegen ständig.
- Der Spieler bewegt sich, dreht den Kopf, bewegt die eigene Hand, strampelt, streckt sich, gähnt, führt den Daumen zum Mund, schluckt, greift und öffnet die Augen – jedes erst ab der Woche, in der der Körper es kann (`GenesisFetalLogic::CanPerform`). Platz zum Bewegen nimmt im letzten Drittel ab.
- Sinne: die eigene Hand im Gegenlicht (neues Skelettnetz `SK_GEN_FetalHand` aus Blender); Vibration nach dem Tastsinn (Tritt, Daumen, Schlucken, ihr Puls, die pulsierende Nabelschnur); Geschmack des Fruchtwassers nach ihren Mahlzeiten (Mennella 1995/2001); Wasserlassen als Körpergefühl.
- Die Mutter antwortet auf gespürte Tritte: Sie legt die Hand auf den Bauch – ein Schatten im Licht, Druck, oft ihre Stimme.
- HUD: Handlungen dieser Woche mit Tasten, eine Zeile für das, was das Kind gerade spürt oder schmeckt. Entwicklerbefehl `genesis.Womb.Do`.
- Geprüft im gebauten Spiel; GPU 4,1 ms. Tests Body.Fetal.Actions, People.MotherFlavor; 158 von 158.
- Stand ALPHA. Nächster Schritt: Teil 2b – das Kind in jeder Woche von außen, dann in seine Augen (Doc 37).

### GENESIS-044 (Teil 2b) – Das Kind in jeder Woche, von außen, dann in seine Augen
- 2026-09-23: Das Kind selbst ist zu sehen: Grundmodell MPFB2 (MakeHuman, CC0; Erweiterung installiert mit Freigabe des Game Directors), je SSW 12–40 auf recherchierte Wachstumswerte angepasst (Robinson & Fleming, INTERGROWTH-21st, Chitty & Altman), gebeugte Haltung nach Williams Obstetrics. Jeder Moment beginnt außen, dann Fahrt in die Augen.
- Game Director: „Die Füße hängen aus der Fruchtblase.“ Ursachen: Höhle zu klein und quer, Kind am Blick statt an der Körperachse ausgerichtet, Beine im Bauch. Behoben (Doc 37); ab SSW 32 Kopflage.
- Game Director: „Recherchiere auch die Befruchtung.“ Prüfung gegen die Literatur in Doc 38: 6.000 statt ~250 Spermien, Zeit an der Zona 20–60× zu schnell, Cumulus zehnmal zu klein, falsches Wettrennen-Bild. Texte sofort korrigiert („Eine andere Zelle ist verschmolzen.“, keine Platzierung); der Rest als GENESIS-047.
- Geprüft im gebauten Spiel; 158 von 158 Tests. Stand ALPHA.

### GENESIS-047 (Teil 1) – Die Befruchtung, wie sie wirklich abläuft
- 2026-09-23: Umsetzung von Doc 38, Schritte 2, 3 und 5. Belege und Messwerte dort.
- Weniger Zellen: 150 statt 6.000 im Abschnitt vor der Eizelle, das Feld reicht weit zurück und trifft nach und nach ein. Kapazitation als eigener Zustand (gemessen 8,9 % im Schwarm); nur kapazitierte Zellen folgen dem Progesteron, hyperaktivieren und binden. Die Akrosomreaktion kann schon im Cumulus beginnen.
- Neuer Ablauf an der Eizelle: schräg durch die Zona (jetzt 17 µm, Eizelle in Blender neu gebaut), im Mittel 12,7 min; dann der perivitelline Spalt (neuer Zustand), im Mittel 15,6 min bis zur Verschmelzung. Nach der Verschmelzung bindet die Zona nach 5 min nicht mehr, Gebundene lösen sich, wer in ihr steckt, bleibt stecken, Überzählige bleiben im Spalt liegen.
- Die Zeit an der Eizelle läuft sichtbar gerafft (×45, logarithmische Rampe), mit Uhr oben im Bild und der Zahl der Zellen im Spalt; im Zeitraffer keine Bewegungsunschärfe über den Weg zwischen zwei Bildern. Der zweite Polkörper schnürt sich 2,5–3,5 h nach der Verschmelzung ab. Beschriftung „hpi“ ersetzt durch „h seit Verschmelzung“.
- Rennen neu gemessen: gut gelenkt 4 von 5, ohne Führung 0 von 5; je Rennen erreichen 4–10 Zellen die Zona und 1–8 den Spalt – bei der Maus sind es in fast der Hälfte der Fälle 2–9 im Spalt (Dubois 2025).
- Tests: Fertilization.RealTimeline (neu), CapacitationMatters, SingleWinnerAndBlock (Dauer 15–70 min), Race.SkillDecides mit 150 Zellen; 159 von 159.
- Offen (Teil 2): Im Zeitraffer verdeckt der dichte Zellkranz die Zona – Blick auf Zona und Spalt über einen optischen Schnitt, zusammen mit dem Cumulus in echter Größe. Kapazitation als zeitlich begrenzter Zustand. Satz im Vorfilm („Nur einer kommt an.“) wartet auf die Entscheidung des Game Directors.

### GENESIS-047 (Teil 2a) – Cumulus und Eileiter in echter Größe
- 2026-09-23: Game Director: „Fahre fort mit dem Spiel.“ Recherche (Doc 38): ~16.000 Cumuluszellen beim Menschen (PMC3955418), Dichte und zellfreie Gallerte nach der Maus (Chen 2016), Ampulle 4–10 mm.
- Der Cumulus reicht jetzt bis 550 µm, die Gallerte bis 700 µm: 13.400 freie Zellen um die Corona, innen dicht, außen locker. Dieselben Zellen sind Bild (Instanzen, vier Formvarianten aus Blender) und Hindernis (die Spermienspitze gleitet an ihnen entlang).
- Der Eileiter ist doppelt so weit (freier Kanal 1,8 mm, 14 Hauptfalten); Wand und Zilien in Blender neu gebaut.
- Nur 80 Zellen im Abschnitt, 8 % kapazitiert; die Zeit im Spalt streut je Eizelle, nicht je Zelle – so passt die gemessene Zeit der Siegerin (15,8 ± 5,7 min) wieder. Rennen: gut gelenkt 4 von 5, ohne Führung 0 von 5; 2–7 Zellen im Spalt wie bei der Maus.
- In der Gallerte Zeitlupe 0,5 statt 0,3; Anzeige „in der Gallerte“ / „zwischen den Cumuluszellen“. Cumuluszellen ohne Schatten (sonst fransige Sicheln aus der Nähe), mit Kern und Hülle.
- Kamera im Rennen weicht Cumuluszellen aus (wie ein Kamera-Federarm; vorher füllte eine Zelle vor der Linse ein Viertel des Bildes). Zustandszeile unter die Tastenhinweise (bei 900 Zeilen lagen beide übereinander).
- Geprüft im gebauten Spiel: Verschmelzung nach 30 min Biologie, 8 Mitbewerberinnen an der Zona, 9,6 ms je Bild (GPU 7,8 ms). Tests: neu Fertilization.CumulusField; 160 von 160.
- Offen (Teil 2b): Blick auf Zona und Spalt im Zeitraffer, Licht im weiten Eileiter (Wand bleibt fast dunkel), Fäden im äußeren Cumulus.

### GENESIS-047 (Teil 2b) – Der Blick in Zona und Spalt
- 2026-09-23: Game Director: „Fahre fort.“ Im Zeitraffer an der Eizelle war die eigene Zelle nicht zu sehen – erst verdeckt vom Kranz, dann, wie Prüfläufe mit ausgeblendeten Teilen zeigten, aus vier Gründen zugleich: dichte Corona davor, Fortsätze der Coronazellen bis in die Zona, eine Makro-Optik mit wenigen Mikrometern Schärfe und kein Kontrast (blasse Zelle vor blasser Zona).
- Optischer Schnitt wie im Mikroskop: Solange die eigene Zelle an der Eizelle hängt, zeigen Corona, Cumuluszellen und Fäden nur eine dünne Schicht (4 µm vor bis 10 µm hinter dem Kopf, Material-Parameter MPC_GEN_OocyteSection, gerasterter Übergang).
- Profilansicht: Die Kamera blickt aus 65 µm quer zur Zelle und zur Radialen – die Zelle liegt ganz in der Bildebene, die Zona ist ein Band im Querschnitt. Eigene Optik (×2,5, f/22, rund 13 µm Schärfe), Lichtregelung bis ein Hundertstel (vorher doppelt überbelichtet).
- Relief-Kontrast wie Hoffman/DIC an den Spermien und gedämpfter Zona-Rand – nur in dieser Ansicht.
- Prüfhilfen: genesis.Conception.HideEgg, .Profile, .TimeLapse; Protokollzeile mit der tatsächlich gezeichneten Lage der eigenen Zelle.
- Geprüft im gebauten Spiel (Zelle in der Zona und im Spalt sichtbar); 160 von 160 Tests. Stand ALPHA.
- Offen: Fortsätze der Coronazellen sind zu dicke Kegel (echte sind feine Fäden); angeschnittene Zellen zeigen Rastermuster; Eileiterwand im weiten Kanal dunkel.

### GENESIS-047 (Teil 2c) – Keine Fortsätze mehr, die Zelle im Spalt sichtbar
- 2026-09-23: Recherche zu den Fortsätzen der Coronazellen (transzonale Fortsätze): Nach dem LH-Anstieg ziehen sie sich zurück – bei der Maus sind sie 4–8 h danach ganz verschwunden, die Trennung ist Voraussetzung für die Reifeteilung (Amargant 2023, DOI 10.1093/humrep/dead162; Übersicht Xie 2023, DOI 10.3389/fcell.2023.1087612). Der Eisprung folgt beim Menschen ~36 h nach dem Anstieg: Die reife Eizelle im Eileiter hat keine mehr. Die 3 µm dicken Kegel bis in die Zona waren ein Fehler – entfernt (Blender, Formen der Zellen unverändert).
- Schnittkante fast hart (0,5 µm) statt gerastert: angeschnittene Zellen zeigen einen Schnitt, kein zerfallendes Muster.
- Der Kopf im Spalt liegt auf der Membran (2,3 µm über ihr, 80° geneigt): Mittig im 3 µm schmalen Spalt steckte er zur Hälfte im welligen Zellleib und war nicht zu sehen.
- Im Zeitraffer markiert der Kreis die Zellmitte, ohne Bahn (vorher Zickzack aus dem Kopfschlag).
- Geprüft im gebauten Spiel: die Zelle in der Zona und im Spalt sichtbar; 160 von 160 Tests. Stand ALPHA.

### GENESIS-047 (Teil 2d) – Schwimmen statt Zucken
- 2026-09-24, Game Director: „Die Spermie bewegt sich zu zuckend, sie soll realistisch wie in Flüssigkeit schwimmen, der Schwanz zappeln.“ Erst gemessen (neue Prüfhilfe `genesis.Conception.TraceMotion N`: je Bild Schlagphase, Drehung von Kopfachse und Kamera, Kopf im Bild; grüner Punkt am berechneten Kopf), dann behoben:
- Hauptursache: Der Geißel-Shader las die UV verkehrt herum. Der FBX-Weg aus Blender spiegelt V – im Mesh hat die Kopfspitze V = 1 (gemessen). Der Shader hielt deshalb das Geißelende für den starren Kopf und ließ den echten Kopf als freies Ende der Welle mit voller Auslenkung schlagen: Die ganze Zelle peitschte um ihr Schwanzende, im Hyperaktiv-Schlag flog der Kopf 7–15 µm neben seine berechnete Lage. Jetzt `s = (1 − V)·60,6 µm` in Schlag, Dichte und Farbe; der Kopf sitzt in jedem Bild auf seinem Punkt, die Welle läuft vom Hals zur Spitze. Dieselbe Spiegelung bei den Zilien der Eileiterwand (der Fuß schwang, die Spitze stand) – ebenfalls behoben.
- Rechenschritte geglättet: Bei 100 Bildern/s und 4-ms-Schritten fielen je Bild 0, 1 oder 2 Schritte an; der Schlag sprang um 0°, 34° oder 68°. Gezeichnet wird jetzt zwischen den letzten beiden Schritten (gemessen: Phase rückt je Bild gleichmäßig 0,04–0,07 Zyklen vor, keine Stillstände).
- Kopfdrehung nur noch am Kopf: Die Geißel nimmt die Kopfdrehung über 12 µm und den Seitenversatz über 25 µm wieder heraus und bleibt als Welle auf der Bahn. Richtungsänderungen als geglättete Drehgeschwindigkeit (Gedächtnis 0,15 s) statt Sprüngen je Schritt – gleiche Streuung der Bahnen.
- Kamera: kein Ausweichen mehr um Cumuluszellen (die Ansicht sprang von Bild zu Bild), stattdessen blenden Zellen zwischen Linse und eigenem Kopf weich aus. In der Ich-Perspektive weicht die Linse an der Kanalwand nach unten aus (mit Hysterese).
...
- HUD: Die Bahn der eigenen Zelle ist die Durchschnittsbahn (VAP) – die alle 0,1 s abgetastete Kopfbahn war ein bedeutungsloses Zickzack.
- **Fäden im äußeren Cumulus bewusst nicht gebaut:** Die Hyaluronsäure-Matrix ist nur im Elektronenmikroskop sichtbar (Dandekar 1992, Talbot 1984), im Lichtmikroskop klar (Doc 38).
- **Das Kind am Termin passt in die Höhle:** Haltung zum Termin als Fruchtwalze (mehr Rundrücken, Hüft- und Kniebeugung, Beine näher beieinander) statt größerer Höhle – die Höhle war schon größer als die ganze Gebärmutter außen. Neues Prüfwerkzeug `Tools/Blender/Gestation/fetus_fit.py` rechnet die Passung wie das Spiel für jede halbe Woche: SSW 34–40 jetzt ≤ 1,00 (vorher SSW 40: 1,06, Füße durch die Wand). Nur in der Drehung SSW 31,5–32,5 ragt das Kind heraus – das liegt im Zeitraffer zwischen den Momenten.
- **Knie:** Die Faltenglättung wirkte um das Knie mit dem Radius der Leiste und glättete die Kniescheibe weg; jetzt eng (0,35 × Oberschenkel).
...
- Nachtrag 2026-09-24: Die Augen scheinen als dunkle Pigmentflecke durch die verklebten Lider (Moore; alle Referenzen SSW 9–12), voll bis SSW 12, verblassend bis 22 – Lage aus dem Augenabstand je Woche (`fetus_eyes.py`). Kamera kreist in den frühen Momenten von der anderen Seite (die Nabelschnur verdeckte das Gesicht). 160 von 160 Tests, gebautes Spiel geprüft.
- Nachtrag 2026-09-24 – **SSW 8 als Embryo:** eigenes Modell `Tools/Blender/Gestation/build_embryo_w08.py` (Carnegie 17–18, Scheitel-Steiß 1,55 cm): Kopf fast so groß wie der Rumpf, seitliche Augen, Ohrhöcker als Ring, Mundspalte, Herz-Leber-Wölbung, Nabelstrang mit ausgetretenem Darm, Handplatten mit Fingerstrahlen vor der Brust, Fußplatten, Schwanzrest. Nachgezeichnet nach einer Seitenansicht (lunar caustic, CC BY 2.0, lokal) und **deckungsgleich geprüft**: Blender rendert das Modell orthografisch im Pixelraum des Fotos und legt beide übereinander – Umriss nach vier Durchgängen auf ~10 px (0,2 mm) genau (vorher Kopf ~20 px zu groß, Bauchwölbung ~50 px zu hoch). Ausgedünnt auf 200 000 Dreiecke (4 MB statt 22 MB, ohne sichtbaren Unterschied). Neuer Moment „Woche 8 – Anderthalb Zentimeter, die Finger zeichnen sich ab“ (Moore, *The Developing Human*), nur von außen.
- Augenpigment im Material mit eigener Blickachse je Alter (`EyeSideways`, Material „AugenSeitlich“): Beim Embryo stehen die Augen seitlich und haben noch keine Lider – kleinere, scharf begrenzte Scheibe; vorher wäre der von vorn projizierte Fleck als Streifen über die Kopfseite gelaufen.
- **Schärfe der Außenansicht:** Die Kamera kreist im Abstand der Körperlänge, der Schärfebereich schrumpft dann mit der Größe des Kindes – beim Embryo war nur das Auge scharf (Prüfbild ohne Tiefenunschärfe zeigte die Ursache). Blende jetzt mit der Größe unter 5 cm geschlossen; draußen bleibend als Fetoskop (kleiner Sensor → große Schärfentiefe, f/8 Kleinbild-Äquivalent). Nebenwirkung: SSW 12 jetzt durchgehend scharf.
- Tests: GestationPlan (Momente SSW 8, 10, 12, 16); 160 von 160. `fetus_fit.py` ab SSW 8: Passung 0,61. Gebautes Spiel geprüft (SSW 8). Stand ALPHA.
- Nachtrag 2026-09-24 – **Herz und Leber scheinen durch** (Referenzen SSW 7 und 9): Lage und Radius je Alter aus dem Modell ins Material; dunkelrot in Grundfarbe, Durchlicht und Streufarbe. Gemessen statt geschätzt: Die Streufarbe des Subsurface-Modells hatte die Farbe überdeckt; ein beleuchteter Maskentest täuschte volle Maske vor (10 % reichten für volles Rot); die kleine Höhle hellt wie eine Ulbrichtkugel auf (Haut-Median 0,86 → 0,80 mit bis −0,4 EV). Kamera beim Embryo von der Seite. 160 von 160 Tests, gebautes Spiel geprüft.
- Nachtrag 2026-09-24 – **Nabelgefäße auch von vorn sichtbar:** Die Gefäßspirale wirkte nur auf das Durchlicht von hinten; in der Außenansicht (Kaltlicht) war die Schnur deckend weiß. Jetzt auch in Grund- und Streufarbe, weich violett-rot, Sulze weniger weiß (Referenz SSW 10 frisch). Ich-Sicht SSW 34 unverändert; gebautes Spiel geprüft (SSW 12).
- Nachtrag 2026-09-24 – **Lookdev gegen das Foto** (Game Director: „alles hyperrealistisch, wie die Referenzbilder, immer Blender und Unreal“): `lookdev_embryo_w08.py` rendert in Cycles mit der Kamera von Referenz 11 neben dem Foto. Zwölf Durchgänge: Streuung 1,2 → 0,7 mm (vorher weiß ohne Form), matte fleckige Haut, dicke abstehende Glieder mit Pfoten-Hand und gebeugten Beinen, Gliedmaske in UV 0 (heller), Auge als Ring mit Linse, Ohrring, Kieferform mit Mund. In Unreal übernommen; Kaltlicht schräg von oben links mit weichen Schatten (vorher an der Optik ohne Schatten: flach), in der Höhle gehalten, Wand/Plazenta ohne Schattenwurf. 160 von 160 Tests, gebautes Spiel geprüft (SSW 8, SSW 12).
- Offen, als nächster Block: **Umgebung der frühen Wochen** – Amnionblase, Dottersack, Chorionhöhle mit Zotten statt glatter Wand und Termin-Plazenta. Außerdem Gefäße am Kopf; physiologischer Nabelbruch bei SSW 10–12; das Kind ist starr (Bewegung von außen nur als Ganzkörper-Ruck).
